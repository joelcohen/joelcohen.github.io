...
**Solution :** <a onclick="toggle_visibility('exo3');"> *(afficher/masquer la solution)*</a>
<div id="exo3" class="sol">
	<img src="/img/daily/exo3sol.jpg" style="border-radius : 1em;"/>
</div>

<span class="date">25/03/2026 : **Dimension et bases**</span>

<img src="/img/daily/exo2.png" style="border-radius : 1em;"/>


**Solution :** <a onclick="toggle_visibility('exo2');"> *(afficher/masquer la solution)*</a>
<div id="exo2" class="sol">
...
<span class="date">24/03/2026 : **Changement de bases**</span>


<img src="/img/daily/exo1.png" style="border-radius : 1em;"/>


**Solution :** <a onclick="toggle_visibility('exo1');"> *(afficher/masquer la solution)*</a>
<div id="exo1" class="sol">
	<img src="/img/daily/exo1sol.png" style="border-radius : 1em;"/>
</div> -->

<span class="date">23/03/2026 : **Dimension et base en cartésien**</span>
