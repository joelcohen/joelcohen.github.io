...
-   **Rendu du code** via un repository GitHub (ou git équivalent). Date limite : le 18 avril 2019. Seuls les commits effectués sur votre projet avant cette date seront pris en compte.

-   **Présentation de 15 minutes**, questions comprises. Il est possible (souhaitable?) de s'aider d'un support visuel pour sa présentation. Pensez à 
